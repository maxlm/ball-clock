# ball-clock
Ball Clock implementation. See problem description below. 

# requirements
 - Current Ball Clock implementation does heavy usage of ES6 features. 
So, you'll need Node version 6.9 or later (tested on Node v6.9.1)
 - Mac or Linux. Probably it will work on Win too, but haven't tested because I don't have Win
 
#installation
 - Clone repo
 - open terminal and navigate to the repo root folder
 - run node main.js
 - enjoy

# ball-clock problem description
